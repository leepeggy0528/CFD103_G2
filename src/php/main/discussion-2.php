                    ...
                    <div class="section-all">
                        <div class="section">
                            ...
                            <div class="group-tag">
                                <span>標籤:</span>
                                <div class="tag-1">
                                <input type="radio" name="post_type"  value="美食">美食
                                <input type="radio" name="post_type" value="夜市">夜市
                                <input type="radio" name="post_type" value="學習">學習
                                <input type="radio" name="post_type"  value="運動">運動
                                </div>

                                <div class="tag-2">
                                <input type="radio" name="post_type"  value="休閒">休閒
                                <input type="radio" name="post_type"  value="購物">購物
                                <input type="radio" name="post_type" value="旅行">旅行
                                <input type="radio" name="post_type"  value="燒腦">燒腦
                                </div>
                            </div>
...
<script src="./js/loginLightbox.js" asyn></script>
        ...
        btn.onclick = function(){
            ...
            if(titles.value == ''){
                ...
                instaTitle.classList.add("title"); 
